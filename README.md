...
1. Download the latest APK from the [Releases page](https://github.com/pippopapera/RomMMobile/releases).
...
Version **1.0.2**, under active development. Working: library, installed shelf, downloads, folder mapping, firmware, gamepad navigation. Not yet: writing `gamelist.xml` for the frontend, syncing collections and save files.
